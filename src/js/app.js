    ...
    $('#quick-grid').html(`
      <div class="qgt-toolbar">
        ...
        <button class="qgt-icon-btn" title="Lịch sử">
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"></path><path d="M3 3v5h5"></path><path d="M12 7v5l4 2"></path></svg>
        </button>

        <div class="qgt-vsep"></div>

        <button class="pg-btn" id="pg-prev" ${_quickPage === 0 ? 'disabled' : ''}>
        ...
        <button class="pg-btn" id="pg-next" ${_quickPage >= totalPages - 1 ? 'disabled' : ''}>
        ...
        <button class="qgt-icon-btn" id="btn-open-filter" title="Lọc sản phẩm">
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"></polygon></svg>
        </button>
        <button class="qgt-icon-btn qgt-icon-btn-accent" id="btn-toggle-quickgrid" title="Ẩn/Hiện lưới sản phẩm">
          <svg width="11" height="11" viewBox="0 0 10 6" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="1 1 5 5 9 1"/></svg>
        </button>
      </div>
